...
class ChatLLM:
    def __init__(self, input_query, operation_type=None, task_type=None, sql_response=None):
    ...
    def generate_success_template(self):
        ...
        The user query is: {self.input_query}
        You have got the following response from the SQL operation: {self.sql_response["response"]}
    ...
    def generate_response(self, input_query):
        ...
        return chain.invoke({"input": input_query})
